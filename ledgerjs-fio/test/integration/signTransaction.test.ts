...
describe("signTransaction", async () => {
  ...
  //     await fio.sendData(
  //       "ref_block_num",
  //       basicTx["ref_block_num"],
  //       ENCODING_UINT16
  //     );
  //     await fio.sendData(
  //       "ref_block_prefix",
  //       basicTx["ref_block_prefix"],
  //       ENCODING_UINT32
  //     );
  ...
  //     await fio.sendData(
  //       "cf_act_amt",
  //       basicTx["context_free_actions"].length.toString(),
  //       ENCODING_UINT8
  //     );
  //     await fio.sendData(
  //       "act_amt",
  //       basicTx["actions"].length.toString(),
  //       ENCODING_UINT8
  //     );
  ...
  //     await fio.sendData(
  //       "num_auths",
  //       basicTx["actions"][0]["authorization"].length.toString(),
  //       ENCODING_UINT8,
  //       0
  //     );
  //     await fio.sendData(
  //       "actor",
  //       parseNameString(
  //         basicTx["actions"][0]["authorization"][0]["actor"],
  //         InvalidDataReason.INVALID_ACTOR
  //       ),
  //       ENCODING_HEX,
  //       0
  ...
  //       "permission",
  //       parseNameString(
  //         basicTx["actions"][0]["authorization"][0]["permission"],
  //         InvalidDataReason.INVALID_PERMISSION
  //       ),
  //       ENCODING_HEX,
  //       0
  ...
  //     await fio.sendData(
  //       "pubkey",
  //       basicTx["actions"][0]["data"]["payee_public_key"],
  //       ENCODING_STRING,
  //       0,
  //       true
  //     );
  ...
  //     await fio.sendData(
  //       "max_fee",
  //       basicTx["actions"][0]["data"]["max_fee"],
  //       ENCODING_UINT64,
  //       0,
  //       true
  //     );
  ...
  //     await fio.sendData(
  //       "tpid_len",
  //       basicTx["actions"][0]["data"]["tpid"].length.toString(),
  //       ENCODING_UINT8,
  //       0
  //     );
  //     await fio.sendData(
  //       "tpid",
  //       basicTx["actions"][0]["data"]["tpid"],
  //       ENCODING_STRING,
  //       0
  //     );
