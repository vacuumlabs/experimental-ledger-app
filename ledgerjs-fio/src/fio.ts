...
export class Fio {
    ...
    * _endHash(): Interaction<EndHashResponse> {
    ...
    async sendDataNoDisplay(): Promise<SendDataNoDisplayResponse> {
        return interact(this._sendDataNoDisplay(), this._send);
    }

    *_sendDataNoDisplay(): Interaction<SendDataNoDisplayResponse> {
